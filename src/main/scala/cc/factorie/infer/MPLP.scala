    ...
    def getMaxMarginals(v: DiscreteVar): DenseTensor1 = {
      ...
      varyingVariables.size match {
        case 1 =>
          ...
          val assignment = new Assignment1(v, v.domain(0).asInstanceOf[v.Value])
        ...
        case 2 =>
          ...
          val assignment = new Assignment2(v, v.domain(0).asInstanceOf[v.Value], other, other.domain(0).asInstanceOf[v.Value])
